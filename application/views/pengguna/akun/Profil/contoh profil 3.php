							...
							<div class="row">
								...
								<div class="row">							
										<div class="col-md-9 col-md-offset-3">
											...
											<div class="col-md-6">
												<input type="text" name="f_name" value= "Ekky Melynda" disabled>
											</div>
										</div>
										<div class="col-md-9 col-md-offset-3">
											<div class="col-md-2">
											...
											<div class="col-md-6">
												<input type="text" name="l_name" placeholder="Last name" value="5113100093" disabled>
											</div>
										</div>
										<div class="col-md-9 col-md-offset-3">
											<div class="col-md-2">
											...
											<div class="col-md-6">
												<input type="text" name="email" placeholder="E-mail" value="081234567890" disabled>
											</div>
										</div>
										<div class="col-md-9 col-md-offset-3">
											<div class="col-md-2">
										...
										<div class="col-md-9 col-md-offset-3">
											...
											<div class="col-md-6">
												<input type="text" name="tel" placeholder="Telephone Number" value="e" disabled>
											</div>
										</div>
								</div>
							</div>
