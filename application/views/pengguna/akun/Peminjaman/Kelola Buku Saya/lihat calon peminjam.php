								...
								<div class="col-md-12">
									<table>
										<tbody>
											...
											<tr>
												<td>1</td>
												<td><a href="<?php echo base_url(); ?>sipti_controller/contoh_profil">Siapa hayo</a></td>
												<td>10 hari</td>
												<td>
													<p class="clearfix" style="text-align:center">
														<a href="#" class="button-sm green text-white hover-green hover-text-white">Pinjamkan</a>
													</p>
												</td>
											</tr>
											<tr>
												<td>2</td>
												<td><a href="<?php echo base_url(); ?>sipti_controller/contoh_profil">Bukan saya</a></td>
												<td>10 hari</td>
												<td>
													<p class="clearfix" style="text-align:center">
														<a href="#" class="button-sm green text-white hover-green hover-text-white">Pinjamkan</a>
