					...
					<div class="col-md-12">
						<div class="">		
									<ul class="inline-list filter-tags center-me gallery-tags">
										<li>
											<a href="<?php echo base_url(); ?>sipti_controller/koleksi_buku_saya" class="text-dark hover-text-white hover-aquablue">Koleksi Buku Saya</a>
										</li>
										<li>
											<a href="<?php echo base_url(); ?>sipti_controller/daftarkan_buku" class="aquablue text-white hover-text-white hover-aquablue">Daftarkan Buku</a>
										</li>
									</ul>
								</div>
								<br>
