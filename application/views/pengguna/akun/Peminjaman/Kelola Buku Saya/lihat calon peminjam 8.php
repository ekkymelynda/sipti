				...
				<div class="row">
					<div class="col-md-12">
						<div class="text-dark-blue text-center fancy-heading">
							<h1 class="font-700">Daftar Calon Peminjam</h1>
									...
									<div class="grey booking-info">
										<div class="row">
											...
											<div class="col-md-10 col-sm-9">
												<h3 class="blog-title text-dark-blue font-300">Head First Design Patterns 1st Edition</h3>
										...
										<tbody>
											...
											<tr>
												...
												<td>
													...
													<a href="<?php echo base_url(); ?>sipti_controller/lihat_calon_peminjam_5" class="read-more soft-corners text-white button-sm hover-orange blue">Verifikasi Kembali</a>
											...
											<tr>
												...
												<td>
													<p class="clearfix" style="text-align:center">
														<a class="read-more soft-corners text-white button-sm hover-orange blue">Tidak Dipinjamkan</a>
													</p>
												</td>
											</tr>
										</tbody>
